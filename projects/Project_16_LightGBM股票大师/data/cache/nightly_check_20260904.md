# Project_16 夜间检修 2026-09-04 01:01

**结论**：FAIL 1 / WARN 1 / 总检查 22

| 模块 | 检查项 | 状态 | 说明 |
|---|---|---|---|
| A | A1 增量库最新日 | **PASS** | 2026-09-03 |
| A | A3 moneyflow最新日 | **PASS** | moneyflow 2026-09-02（增量 2026-09-03，滞后应<=5自然日） |
| A | A2 主数据源文件 | **PASS** |  |
| A | A4 财务PIT最新日 | **PASS** | 2026-08-21 |
| B | B1 面板最新日 | **PASS** | 2026-09-03 |
| B | B2 模型-面板同步 | **PASS** | 校验结果: 一致（面板与正式模型同版） |
| B | B3 正式模型存在 | **PASS** | 22625 KB |
| B | B4 G2 候选产物 | **PASS** | 最近: 20260903_g2_top10.csv |
| C | C2 前日任务日志 | **PASS** | 当日日志 37 条 |
...
| F | F1 磁盘 D盘 | **PASS** | 剩余 78.2 GB |
| F | F1 磁盘 QMT_POOL | **PASS** | 剩余 78.2 GB |
| F | F2 QMT_POOL清理 | **PASS** | 清理 35 个旧文件 |
| F | F3 脚本冒烟 | **PASS** |  |
