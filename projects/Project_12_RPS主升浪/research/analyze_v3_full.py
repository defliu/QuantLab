...
REPORT = "D:/QuantLab/reports/20260814_132439_134c98_rps_momentum_v3_balanced"
...
if len(td) > 0:
    ...
    # 亏损最大的交易
    print("\n=== 最大亏损单（前 10）===")
    worst = td.nsmallest(10, "pnl")
    print(worst[["code", "buy_date", "sell_date", "ret", "pnl"]].to_string())
