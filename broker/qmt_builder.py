...
用法:
  ...
  输出: D:/QuantLab/projects/Project_01_多因子IC小盘Alpha/build/strategy_mfic.py (生产版)
...
if __name__ == "__main__":
    ...
    save_strategy(code, 'D:/QuantLab/projects/Project_01_多因子IC小盘Alpha/build/strategy_mfic.py')
